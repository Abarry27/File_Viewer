...
new_font = ['Times New Roman', 12, 'normal']
...
def save_file_as():
    text_file = filedialog.asksaveasfilename(defaultextension=".*", initialdir="C:/Desktop/", title = "Save File", filetypes=(("PDF Files", "*.pdf"), ("Text Files ", "*.txt")))
    if text_file:
        name = text_file
...
bold_button.grid(row=0, column=0, sticky=W, padx=3.5, pady=1.75)
